                           ...
                           <div class="form">
                              <div class="md:space-y-2 mb-3">
                                 ...
                                 <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                    <input type="tel"
                                          class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border border-l-1 h-10 border-grey-light rounded-lg rounded-l-1 px-3 relative focus:border-blue focus:shadow"
                                          placeholder="(+36...)" name="phone_number">
                                 </div>
                                 @error('phone_number')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                                 @enderror
                                 ...
                                 <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                       <input type="text"
                                             class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border border-l-1 h-10 border-grey-light rounded-lg rounded-l-1 px-3 relative focus:border-blue focus:shadow"
                                             placeholder="City, address" name="address">
                                    </div>
                                    @error('address')
                                       <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                 ...
                                 <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    <div class="w-full flex flex-col mb-3">
                                       <label class="font-semibold text-gray-600 py-2">ZIP Code<abbr
                                    ...
                                    <div class="w-full flex flex-col mb-3">
                                       <label class="font-semibold text-gray-600 py-2">Country<abbr
                                             title="required">*</abbr></label>
                                       <select
                                 ...
                                 <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                    ...
                                    <textarea name="message" id=""
                                             ...
                                             placeholder="Enter extra information" spellcheck="false">
                                    </textarea>
                                 </div>

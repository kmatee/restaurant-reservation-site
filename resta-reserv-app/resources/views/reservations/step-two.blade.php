                            ...
                            <form method="POST" action="{{ route('reservations.store.step.two') }}">
                                ...
                                <div class="mt-6 p-4 flex justify-between">
                                    <a href="{{ route('reservations.step.one') }}"
                                        class="px-4 py-2 bg-blue-600 text-white hover:bg-blue-500 rounded-md transition-color duration-300">Previous</a>
                                    <button type="submit"
                                        class="px-4 py-2 bg-blue-600 text-white hover:bg-blue-500 rounded-md transition-color duration-300">Make
                                        Reservation</button>
                                </div>
                            </form>
                        </div>
